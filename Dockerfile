...
COPY --from=compile-image "/code/csw_updater.egg-info/" "/code/csw_updater.egg-info/"
COPY --from=compile-image "/code/csw_updater" "/code/csw_updater"
